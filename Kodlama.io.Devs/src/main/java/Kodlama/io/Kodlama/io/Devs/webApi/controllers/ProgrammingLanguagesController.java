...
public class ProgrammingLanguagesController {
	...
	@GetMapping("/addsubtechnology")
	public ProgrammingLanguage addSubtechnology(ProgrammingLanguage programmingLanguage, Subtechnology subtechnology1,
			Subtechnology subtechnology2) {
		System.out.println("Please enter Programming Language");
		programmingLanguage.setProgrammingLanguage(scan.nextLine());
		System.out.println("Please enter first subtechnology");
		subtechnology1.setSubtechnology(scan.nextLine());
		System.out.println("Please enter second subtechnology");
		subtechnology2.setSubtechnology(scan.nextLine());
		programmingLanguageService.addSubtechnology(programmingLanguage, subtechnology1, subtechnology2);
		return programmingLanguage;
	}
}
